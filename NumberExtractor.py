...
json_file = open('D:\\Python Projects\\SolveSudoku-master\\SolveSudoku-master\\models\\model.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
# load weights into new model
loaded_model.load_weights("D:\\Python Projects\\SolveSudoku-master\\SolveSudoku-master\\models\\model.h5")
